...
function cmp$2(a, b) {
  return Caml_primitive.caml_int_compare(a._0, b._0);
}

var NewtypeIntKeyComparable = Belt_Id.MakeComparable({
      cmp: cmp$2
    });

function encodeNewtypeIntKeyMap(x) {
  return Aeson_encode.object_({
              hd: [
                "newtypeIntKeyMap",
                Aeson_encode.beltMapString((function (prim) {
                        return prim;
                              ...
                              }), Belt_Map.toArray(x.newtypeIntKeyMap))))
              ],
              tl: /* [] */0
            });
}

function decodeNewtypeIntKeyMap(json) {
  var v;
  try {
    v = {
      newtypeIntKeyMap: Belt_Map.fromArray($$Array.map((function (param) {
                  return [
                          /* NewtypeInt */{
                            _0: Caml_format.caml_int_of_string(param[0])
                          },
                          param[1]
                        ];
                }), Belt_MapString.toArray(Aeson_decode.field("newtypeIntKeyMap", (function (param) {
                          return Aeson_decode.beltMapString(Aeson_decode.string, param);
                        }), json))), NewtypeIntKeyComparable)
    };
  }
  catch (raw_msg){
    var msg = Caml_js_exceptions.internalToOCamlException(raw_msg);
    if (msg.RE_EXN_ID === Aeson_decode.DecodeError) {
      return {
              TAG: /* Error */1,
              _0: "decodeNewtypeIntKeyMap: " + msg._1
            };
    }
    throw msg;
  }
...
Jest.describe("newtypeInt", (function (param) {
        return Jest.test("newtype int wrapper key map", (function (param) {
                      return jsonRoundtripSpec(decodeNewtypeIntKeyMap, encodeNewtypeIntKeyMap, JSON.parse("{\"newtypeIntKeyMap\":{\"1\":\"A\",\"2\":\"B\"}}"));
                    }));
      }));
...
exports.NewtypeIntKeyComparable = NewtypeIntKeyComparable;
exports.encodeNewtypeIntKeyMap = encodeNewtypeIntKeyMap;
exports.decodeNewtypeIntKeyMap = decodeNewtypeIntKeyMap;
