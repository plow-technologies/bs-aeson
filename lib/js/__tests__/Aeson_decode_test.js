...
var Aeson = require("../src/Aeson.js");
...
Jest.describe("bool", (function (param) {
        Jest.test("bool", (function (param) {
                Jest.Expect.toEqual(true, Jest.Expect.expect(Aeson_decode.bool(true)));
                return Jest.Expect.toEqual(true, Jest.Expect.expect(Curry._1(Aeson.Bool.decodeUnsafe, Aeson.Bool.encode(true))));
              }));
...
Jest.describe("int", (function (param) {
        ...
        Jest.test("int", (function (param) {
                return Jest.Expect.toEqual(123, Jest.Expect.expect(Curry._1(Aeson.Int.decodeUnsafe, Aeson.Int.encode(123))));
              }));
...
Jest.describe("int64", (function (param) {
        Jest.test("int64", (function (param) {
                return Jest.Expect.toEqual(/* int64 */[
                            /* hi */0,
                            /* lo */23
...
Jest.describe("int64_of_array", (function (param) {
        Jest.test("int64_of_array", (function (param) {
                return Jest.Expect.toEqual(/* int64 */[
                            /* hi */0,
                            /* lo */23
                          ], Jest.Expect.expect(Aeson_decode.int64_of_array(/* int64 */[
                                    /* hi */0,
                                    /* lo */23
                                  ])));
              }));
...
Jest.describe("nativeint", (function (param) {
        Jest.test("nativeint", (function (param) {
                return Jest.Expect.toEqual(23, Jest.Expect.expect(Aeson_decode.nativeint(23)));
              }));
        return Jest.test("nativeint", (function (param) {
                      return Jest.Expect.toEqual(-23223, Jest.Expect.expect(Aeson_decode.nativeint(-23223)));
                    }));
      }));
...
Jest.describe("uint16", (function (param) {
        ...
        return Jest.test("uint16", (function (param) {
                      return Jest.Expect.toEqual(U.UInt16.maxInt, Jest.Expect.expect(Aeson_decode.uint16(Aeson_encode.uint16(U.UInt16.maxInt))));
                    }));
      }));
...
Jest.describe("uint32", (function (param) {
        ...
        return Jest.test("uint32", (function (param) {
                      return Jest.Expect.toEqual(U.UInt32.ofInt64(/* int64 */[
                                      /* hi */0,
                                      /* lo */4294967295
                                    ]), Jest.Expect.expect(Aeson_decode.uint32(Aeson_encode.uint32(U.UInt32.ofInt64(/* int64 */[
                                                  /* hi */0,
                                                  /* lo */4294967295
                                                ])))));
                    }));
...
Jest.describe("uint64", (function (param) {
        ...
        return Jest.test("uint64", (function (param) {
                      return Jest.Expect.toEqual(U.UInt64.maxInt, Jest.Expect.expect(Aeson_decode.uint64(Aeson_encode.uint64(U.UInt64.maxInt))));
                    }));
      }));

Jest.describe("bigint", (function (param) {
        Jest.test("bigint", (function (param) {
                return Jest.Expect.toEqual(Bigint.of_int(23), Jest.Expect.expect(Curry._1(Aeson.Bigint.decodeUnsafe, Aeson_encode.bigint(Bigint.of_int(23)))));
              }));
        return Jest.test("bigint", (function (param) {
                      return Jest.Expect.toEqual(Bigint.of_int(26423), Jest.Expect.expect(Curry._1(Aeson.Bigint.decodeUnsafe, Aeson_encode.bigint(Bigint.of_int(26423)))));
                    }));
      }));
...
Jest.describe("optional", (function (param) {
        ...
        Jest.test("int64 -> int64", (function (param) {
                return Jest.Expect.toEqual(/* int64 */[
                            /* hi */0,
                            /* lo */64
                          ], Jest.Expect.expect(Aeson_decode.optional(Aeson_decode.int64_of_array, /* int64 */[
                                    /* hi */0,
                                    /* lo */64
                                  ])));
              }));
...
Jest.describe("result", (function (param) {
        Jest.test("Ok", (function (param) {
                return Jest.Expect.toEqual(/* Error */Block.__(1, ["hello"]), Jest.Expect.expect(Aeson_decode.result(Aeson_decode.$$int, Aeson_decode.string, JSON.parse(" {\"Error\": \"hello\"} "))));
              }));
        return Jest.test("Error", (function (param) {
                      return Jest.Expect.toEqual(/* Ok */Block.__(0, [2]), Jest.Expect.expect(Aeson_decode.result(Aeson_decode.$$int, Aeson_decode.string, JSON.parse(" {\"Ok\": 2} "))));
                    }));
      }));

Jest.describe("either", (function (param) {
        Jest.test("Right", (function (param) {
                return Jest.Expect.toEqual(/* Right */Block.__(1, ["hello"]), Jest.Expect.expect(Aeson_decode.either(Aeson_decode.$$int, Aeson_decode.string, JSON.parse(" {\"Right\": \"hello\"} "))));
              }));
        return Jest.test("Left", (function (param) {
                      return Jest.Expect.toEqual(/* Left */Block.__(0, [2]), Jest.Expect.expect(Aeson_decode.either(Aeson_decode.$$int, Aeson_decode.string, JSON.parse(" {\"Left\": 2} "))));
                    }));
      }));
